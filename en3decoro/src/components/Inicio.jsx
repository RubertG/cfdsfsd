    ...
    return (
        <>
            ...
            <section className='section-izquierda'>
                <h2 className="section-title-left bg-left animar-bajando">
                    Impresiones 3D
                </h2>
                <div className="section-body">
                    <div className="container-img img-derecha  animar-izquierda">
                        <img src='/img/collage-articulos.webp' alt="Objetos impresos en 3D - En3Decoro" />
                    </div>
                    <div className="container-desc animar-bajando">
            ...
            <section className='section-derecha'>
                <h2 className="section-title-right bg-right ">
                    Fabricación
                </h2>
                <div className="section-body">
                    ...
                    <div className="container-desc desc-derecha ">
